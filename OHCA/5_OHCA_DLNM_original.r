...
##### 1-1. GENDER, AGE, Mhistory 변수들 8개로 바꾸기 #####
 # M_under70_mhistory0
 # M_under70_mhistory1
 # M_over70_mhistory0
 # M_over70_mhistory1
...
##### 3. create day #####
  ...
  # table(patient$count_disease,patient$year)
...
##### 5. create patient_esf data & fit model with ESF #####
  ...
  # 5-1. ns.basis_no
    ...
    # table(patient_esf$count_disease)
    # mean(patient_esf$count_disease)
    # poi_test=rpois(n=sum(patient_esf$count_disease),lambda=0.1531)
    # table(poi_test)   
