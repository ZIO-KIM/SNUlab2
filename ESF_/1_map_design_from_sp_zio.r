...
#수도권
# 01.14 수도권 75개 인덱스 있는 지도 파일로 수정함 - 취소
# 08.08 outcome asthma, rhinitis, atopic 일 때는 72개로
# col.poly_sudogwon <- st_read("0. data\\out of hospital sudden cardiac arrest\\Z_SOP_BND_SIGUNGU_sudogwon_75\\Z_SOP_BND_SIGUNGU_sudogwon_75_2.shp", options = "ENCODING=UTF-8")
col.poly_sudogwon <- st_read("0. data\\out of hospital sudden cardiac arrest\\Z_SOP_BND_SIGUNGU_sudogwon.shp", options = "ENCODING=UTF-8")
...
n_sudogwon = 72  # 08.08 outcome asthma, rhinitis, atopic 일 때는 72개로
...
head(C_sudogwon) # -> 이게 connectivity matrix 인듯?
